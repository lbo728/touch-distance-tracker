...
class TouchDistanceTracker {
    ...
    constructor(config = {}) {
        ...
        this.storageConfig = {
            storageKey: ((_a = config.storageConfig) === null || _a === void 0 ? void 0 : _a.storageKey) || defaultStorageKey,
            touchLogKey: ((_b = config.storageConfig) === null || _b === void 0 ? void 0 : _b.touchLogKey) || `${defaultStorageKey}-touch-log`,
        };
...
exports.default = TouchDistanceTracker;
